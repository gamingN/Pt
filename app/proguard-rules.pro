...
# in C:\Users\VeeoTech\AppData\Local\Android\Sdk/tools/proguard/proguard-android.txt
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
-keep class com.example.veeotech.postaltracking.pickup.bean.** { *; }
-keep class com.example.veeotech.postaltracking.warehouse.bean.** { *; }
-keep class com.example.veeotech.postaltracking.posHand.** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class com.example.veeotech.postaltracking.R$*{
