...
public class DeliverFragment extends Fragment {
    ...
    Unbinder unbinder;
    @BindView(R.id.btn_warehouse_deliver_barcode)
    Button btnWarehouseDeliverBarcode;
    ...
    public static DeliverFragment getInstance() {
        DeliverFragment fragment;
        fragment = new DeliverFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        btnWarehouseDeliverBarcode.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (NetUtils.isConnected(getActivity())) {
                    SPUtils.put(getActivity(), IntentKeyUtils.SP_RESULT_BACK, "6");
                                ...
                                .subscribe(new Consumer<Permission>() {
                                    ...
                                    public void accept(Permission permission) throws Exception {
                                        if (permission.granted) {
                                            new ScannerUtils(DeliverFragment.this, integrator).selectFragment();
                                        } else {
        ...
        intentFilter.addAction("android.intent.action.MEDICAL6_BROADCAST");
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            SPUtils.put(App.getInstance(), IntentKeyUtils.SP_RESULT_BACK, "6");
        }
        Log.d("fragment", "WareHouse setUserVisibleHint" + isVisibleToUser);
    }

    public void setDeliverStatus(String country_id) {
        Call<FlagBean> flagBeanCall = HttpUtils.getIserver().updateDeliverInfo(country_id);
        flagBeanCall.enqueue(new Callback<FlagBean>() {
            ...
            public void onResponse(Call<FlagBean> call, Response<FlagBean> response) {
                ...
                if (flagBean.getFlag() == 1) {
                    ToastUtil.showToastShort(getActivity(), "出倉成功");
                } else {
                    ToastUtil.showToastShort(getActivity(), "出倉失敗");
                }
